...
| subsystem-news | 0.1.1 | v0.1.3 | unassigned |  |  | health:health_probe=subsystem_news.public:health_probe; smoke:smoke_hook=subsystem_news.public:smoke_hook; init:init_hook=subsystem_news.public:init_hook; version:version_declaration=subsystem_news.public:version_declaration; cli:cli=subsystem_news.public:cli |  | lite-local, full-dev | verified | null | Stage 3 audit passed; milestone-test-baseline v0.1.1 + canonical wire mapper; codex review #4 approved; Stage 4 §4.1.5 harmonized contract_version to v0.1.3 (Ex-1/2/3 producer; pinned to the contracts package version this subsystem is bound against). |
